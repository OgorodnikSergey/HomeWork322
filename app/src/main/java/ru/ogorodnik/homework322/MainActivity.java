package ru.ogorodnik.homework322;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    TextView tvResult;
    Button btnSeven, btnEight, btnNine, btnFour, btnFive, btnSix, btnOne, btnTwo, btnFree, btnZero, btnPoint, btnClear, btnInj;
    String number = " ";
    boolean inj = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInj = (Button) findViewById(R.id.btnInj);
